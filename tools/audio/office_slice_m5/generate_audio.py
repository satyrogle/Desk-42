...
CUES.extend([
    ...
    CueSpec("D", "event.original-recovered", "event.recovery-complete", "SFX", False, 0, 0.62),
    ...
    CueSpec("D", "event.supervisor-authority", "event.copier-promoted", "SFX", False, 0.68, 0.58),
    CueSpec("D", "event.runner-allegiance", "event.runner-allegiance", "SFX", False, -0.10, 0.62),
    CueSpec("D", "event.runner-to-copier", "event.runner-allegiance", "SFX", False, 0.42, 0.62),
    CueSpec("D", "event.runner-to-warden", "event.runner-allegiance", "SFX", False, -0.10, 0.62),
